# Pre-Call Brief -- AI Automation
**Date:** 2026-07-21  |  **Client:** Spadina  |  **Command:** /prep-call
**Status:** prep
---
...
## What We Know
  ...
  Client:     Spadina
  Budget:     not posted
  Type:       automation / medium

  Research:   Private online high school in Toronto, Ontario. Serves international students globally. Rolling enrollment year-round, 24/7 asynchronous model, 30 years in online education. Pain likely in admissions comms, student follow-up, document collection from international applicants.

  Notes from post:
  Booked call directly as AI Automation expert call. No job post — inbound. 30 min Google Meet.
