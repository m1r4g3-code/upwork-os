# Pre-Call Brief -- 5-Channel Social Media Automation
**Date:** 2026-05-28  |  **Client:** Eugen  |  **Command:** /prep-call
**Status:** prep
---

## What We Know

  Project:    5-Channel Social Media Automation
  Client:     Eugen
  Budget:     not posted
  Type:       automation / complex

  Research:   Self-hosted n8n, HeyGen avatar, Google Sheets CMS, 5 channels (TikTok LinkedIn Facebook Instagram YouTube), 2 existing workflows (HeyGen + Blotato), needs Sheets orchestration layer, carousel counter logic, error handling

  Notes from post:
  German client, new Upwork account, detailed brief, contract-to-hire flag, HeyGen vs Kling question, budget 50 fixed
...
## The Kill Shot (open with this)
  ...
  Opening line:
  "I was looking at your [site/product] before the call -- I noticed [SPECIFIC FINDING]. Is that [assumption] accurate, or am I reading it wrong?"
...
## Question Stack
  ...
  [CURRENT STATE]
  1. How are you handling this right now?
  2. Walk me through the current workflow step by step.
  3. How much time does this take your team weekly?
  4. What tools are you using for this currently?
  5. How many people touch this process today?

  [PROBLEM DEPTH]
  6. What made you decide now was the time to fix this?
  7. Have you tried to solve this before? What happened?
  8. When this breaks or slows down -- what is the downstream effect on the business?
